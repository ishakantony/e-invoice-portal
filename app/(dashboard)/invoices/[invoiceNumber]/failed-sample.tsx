...
xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
  ...
  const xmlCodeBeforeConcession = `
      <cac:PartyIdentification>
        <cbc:ID schemeID="TIN">1234567</cbc:ID> 
      </cac:PartyIdentification>`

  const xmlCodeAfterConcession = `
      <cac:PartyIdentification>
          ...
          <Card className="p-2 flex justify-between w-full">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <h1>To</h1>
                  <CodeHighlight code={xmlCodeAfterConcession} language="xml" />
                </div>
              </div>
            </div>
            <div>
        ...
        <div className="flex justify-between gap-4 pt-4">
          <Card className="p-2 flex justify-between w-full">
            <div>
              ...
              <p>
                There's no automatic resolution available, please ammend the
                NRIC manually
              </p>
              <Dialog>
